#!/bin/bash
# 编译 AgentInject2.dylib（供 TrollFools 注入目标 App）
...
( cd build && zip -qry AgentInject2.zip AgentInject2.dylib )
ls -la build/AgentInject2.zip
echo "BUILD_OK"
